    	...
    	<div id="resultBody">
	        ...
	        <div id="result1">
	        	<c:if test="${inserted}">
	        		...
	        		<c:out value="DATE_TIME_EPOCH_IN_SECONDS = ${entity.dateTimeEpochInSeconds}" /><br>
	        		<c:out value="DATE_TIME = ${entity.dateTimeStringified}" />
	       		</c:if>
	       	</div>
	       	<br>
	       	<img class="img3" src="${pageContext.request.contextPath}/resources/img/books.png" alt="books">
	       	<img class="img4" src="${pageContext.request.contextPath}/resources/img/files.png" alt="files">
