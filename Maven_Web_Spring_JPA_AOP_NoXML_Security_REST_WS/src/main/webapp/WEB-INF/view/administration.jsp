...
<html>
    ...
    <body>
		...
		<div>
			...
			<h3>This content is available only to authorized personnel - i.e., admin and manager roles.</h3>
			<h3>Users that do not possess any of these roles, can't access the mapping path to this page.</h3>
			<img src="${pageContext.request.contextPath}/resources/img/administration.png" alt="administration">
		</div>
