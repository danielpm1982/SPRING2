...
tables with initial values (users, roles and relations for user1 until user4).
...
This Controller class, basically deals with the mapping url and persistence regarding the business entity (entityModel).
