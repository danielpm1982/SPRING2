    ...
    <body>
		...
		<div class="misFormDiv">
			<form:form action="addNewPatientResult" modelAttribute="patientModel">
				...
				<form:input type="number" path="address[1].number" min="0" class="inputId" placeholder="Number" onfocus="this.value=''" onblur="if(this.value===''){this.value=0;}" onkeypress="enterFunction(event)" /><br>
